...
function Personnage(image,frame_width,frame_height,frame_duration , viewport , urlSound)
{
	//////////////////////////////////////////////////////////////
	// Attributs
	/////////////////////////////////////////////////////////////
	...
	**/
    this.constructor = function()
	{
		...
		m_reflexion = new Diffraction(viewport );
		m_reflexion.constructor();
	...
	**/
	 ...
	 **/
	this.move = function (tile_map  , array_enemy )
	{
		...
		m_angleReflexion = m_reflexion.madeBall( x , y  , m_sens );
	...
	**/
	...
	/**
	*@brief : Revoit le draw de m_reflexion
	**/
	this.getBalls = function  ()
	{
		return m_reflexion.getListBall();
	}
	
	/**
	*@brief : Renvoit une balle 
	**/
	this.getBall = function ( index )
	{
		return m_reflexion.getBall(index);
	}
	
	this.getAngleReflexion = function ()
	{
		return m_angleReflexion;
	}
	
	/**
	*@brief : Colission entre les perso 
	**/
	function collidesChar ( array_enemy )
	{
		for ( var i = 0 ; i < array_enemy.length ; i++ )
		{
			if ( jaws.collideRects( m_player.rect() , array_enemy[ i ].getRect() ) )
			{
				return true ;
			}
		}
