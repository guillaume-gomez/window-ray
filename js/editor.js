...
function Editor ( )
{
	...
	**/
	this.setup = function () 
	{
		...
		m_listEnnemies = new Array (
		'ennemy.png'
		);
		
		m_level = new MakeLevel ( cell_size , m_listImgURL , m_viewport  , m_listEnnemies);
		m_level.constructor();
	...
	**/
	this.draw = function () 
	{
		...
		m_viewport.draw(m_level.getSpriteLight());
		m_viewport.draw(m_level.getSpriteEnnemy());
		m_viewport.draw(m_level.getSpriteHero());
	}
