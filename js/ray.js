...
function Ray ( _x ,_y , orientation ,  urlIMG ,viewport  )
{
	//////////////////////////////
	// Attributs
	/////////////////////////////
	...
	function makeRay ( m_tile_map , _x , _y)
	{
		...
		var temp  = new jaws.Sprite({ x: _x , y : _y,image: urlIMG});
		m_width = 0 ;	
		decalageY = 0 ;
	 ...
	 //les conditions 
		...
		//creation de tile
		var tmpSprite = new jaws.Sprite({ x: decalageX , y : decalageY,image: urlIMG , alpha : 0.75});
